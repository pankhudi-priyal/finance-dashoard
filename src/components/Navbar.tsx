  ...
  return (
    <nav className="sticky top-0 z-10 border-b border-gray-200 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        <span className="text-base font-semibold text-gray-900 dark:text-white">FinanceDash</span>
        <div className="flex items-center gap-3">
          ...
          <button
            onClick={() => logout()}
            className="rounded-lg px-3 py-1.5 text-sm font-medium text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors"
          >
            Sign out
          </button>
        </div>
